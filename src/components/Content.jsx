                ...
                <div class="container mt-4 ml-5">
                    <div class="row">
                        <div class="col-sm-1" style={BR}>
                            <a href="#" style={A}>Kategori</a>
                        </div>
                        <div class="col-sm-2" style={BR}>
                            <a href="#"style={A}>Semua Promo</a>
                        </div>
                        <div class="col-sm-1" style={BR}>
                            <a href="#"style={A}>Kesehatan</a>
                        </div>
                        <div class="col-sm-3" style={BR}>
                            <a href="#"style={A}>Makanan & Minuman</a>
                        </div>
                        <div class="col-sm-1" style={BR}>
                            <a href="#"style={A}>Dapur</a>
                        </div>
                        <div class="col-sm-1" style={BR}>
                            <a href="#" style={A}>Emas</a>
                        </div>
                        <div class="col-sm-1" style={BR}>
                            <a href="#"style={A}>Pulsa</a>
                        </div>
